...
?>
    <div id="main-container" class="container-fluid edit-profile-page">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="bio" id="bio"  rows="5" placeholder="Conte quem você é, o que você faz e onde trabalha..."><?= $userData->bio ?></textarea>
                    </div>
                </div>
            </div>
        </form>
        <div class="col-md-4">
            <h2>Alterar senha:</h2>
            <p class="page-description">Digite a sua nova senha, e confirme para alterar sua senha:</p>
            <form action="<?= $BASE_URL ?>user_process.php" method="POST">
            <input type="hidden" name="type" valeu="changepassword">
            <div class="form-group">
